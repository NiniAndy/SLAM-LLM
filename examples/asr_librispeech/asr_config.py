...
@dataclass
class ModelConfig:
    file: str = "/ssd/zhuang/code/SLAM-LLM/examples/asr_librispeech/model/slam_model_asr.py:model_factory"
...
class DataConfig:
    ...
    file: str = "/ssd/zhuang/code/SLAM-LLM/src/slam_llm/datasets/speech_dataset.py:get_speech_dataset"
